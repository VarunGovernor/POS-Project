...
export default function DemoPage() {
  ...
  const [toast, setToast] = useState("Demo ready");
        ...
        {stage === "select" ? (
          <section className="screen">
            ...
            <div className="vertical-grid">
              {verticals.map((item) => (
                <button className="vertical-card" key={item.name} onClick={() => choose(item)}>
          ...
          <section className="screen dashboard">
            ...
            <div className="work">
              <div className="topbar">
                ...
                <div className="chips"><span>Offline-first</span><span>Device active</span><span>Dev printer</span></div>
              </div>
...
function Panel(props: {
  ...
  if (props.active === "audit") return <Card title="Audit"><Rows rows={[["Login", "Cashier authenticated", "now"], ["Session opened", "Counter 01", "now"], ["Bill finalized", props.billNumber, props.finalized ? "done" : "ready"], ["Receipt printed", "Development printer", props.printJobs.length > 1 ? "done" : "waiting"], ["Sync retried", "Development adapter", props.syncDone ? "done" : "waiting"], ["Support bundle created", "SUP-DEMO-001", "ready"]]} /></Card>;
